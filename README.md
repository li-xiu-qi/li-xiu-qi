...
|------------|-------------|-------|
| [data_analysis_agent](https://github.com/li-xiu-qi/data_analysis_agent) | 数据分析智能体 (Data Analysis Agent)：基于LLM的智能数据分析智能体 | 206 |
| [financial_research_report](https://github.com/li-xiu-qi/financial_research_report) | 金融多模态研究报告生成 | 143 |
